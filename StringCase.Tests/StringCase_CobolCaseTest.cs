...
{
    public class CobolCase
    {
        [Fact]
        public void ConvertCamelCase()
        {
            var result = StringCase.CobolCase("abcDefGHIjk");
        ...
        {
            var result = StringCase.CobolCase("abc_def_ghi");
        ...
        {
            var result = StringCase.CobolCase("abc-def-ghi");
            Assert.Equal(result, "ABC-DEF-GHI");
        }
        ...
        {
            var result = StringCase.CobolCase("abc123-456defG89HIJklMN12");
        ...
        {
            var result = StringCase.CobolCase(":.abc~!@def#$ghi%&jk(lm)no/?");
        ...
        {
            var result = StringCase.CobolCase("123abc456def");
        ...
        {
            var result = StringCase.CobolCase("");
            Assert.Equal(result, "");
        }
    }

    public class CobolCaseWithOptions
    {
        public class NonAlphabetsAsHeadOfWord
        {
            ...
            public void ConvertCamelCase()
            {
                ...
                var result = StringCase.CobolCaseWithOptions("abcDefGHIjk", opts);
                Assert.Equal(result, "ABC-DEF-GH-IJK");
            }
            ...
            {
                var opts = new Options(true, false, null, null);
                var result = StringCase.CobolCaseWithOptions("abc_def_ghi", opts);
                Assert.Equal(result, "ABC-DEF-GHI");
            }
            ...
            {
                var opts = new Options(true, false, null, null);
                var result = StringCase.CobolCaseWithOptions("abc-def-ghi", opts);
                Assert.Equal(result, "ABC-DEF-GHI");
            }
            ...
            {
                var opts = new Options(true, false, null, null);
                var result = StringCase.CobolCaseWithOptions("abc123-456defG89HIJklMN12", opts);
            ...
            {
                var opts = new Options(true, false, null, null);
                var result = StringCase.CobolCaseWithOptions(":.abc~!@def#$ghi%&jk(lm)no/?", opts);
                Assert.Equal(result, "ABC-DEF-GHI-JK-LM-NO");
            }
            ...
            {
                var opts = new Options(true, false, null, null);
                var result = StringCase.CobolCaseWithOptions("123abc456def", opts);
            ...
            {
                var opts = new Options(true, false, null, null);
                var result = StringCase.CobolCaseWithOptions("", opts);
                Assert.Equal(result, "");
            }
        }
        ...
        public class NonAlphabetsAsHeadOfWordAndWithSeparators
        {
            ...
            public void AlphabetsAndNumbersInSeparatorsAreNoEffect()
            {
                ...
                var result = StringCase.CobolCaseWithOptions("abc123def", opts);
